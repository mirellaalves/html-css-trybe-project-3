...
- [x] **1 - O corpo da página deve possuir uma cor (diferente da cor branca) como cor de fundo**

- [x] **2 - A página deve possuir uma barra superior fixa com o ID "cabecalho"**

- [x] **3 - A página deve possuir um rodapé com o ID "rodape"**

- [x] **4 - A página deve possuir pelo menos uma imagem criada com a tag "img"**

- [x] **5 - A página deve possuir duas listas, uma ordenada e a outra não**

- [x] **6 - A página deve possuir pelo menos um link externo (não se esqueça de configurar a abertura desse link em uma nova aba)**
...
- [x] **8 - Seu site deve passar sem problemas na verificação de semântica do site achecker**
...
- [x] **3 - Altere atributos relacionados as fontes, como por exemplo, tamanho, cor, alinhamento, decoração (itálico, negrito, sublinhado etc)**
